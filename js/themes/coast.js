/**
 * coast.js — theme "Bờ Biển": mặt trời/trăng theo giờ thực, hệ thời tiết
 * (nắng/mây/mưa/tuyết/sương/bão) tự động hoặc thủ công, SFX sóng biển +
 * sấm sét, sao băng ban đêm...
 *
 ...
 * (coast-frame.html) thay vì mổ xẻ và nhúng trực tiếp vào DOM chính.
 * Lý do:
...
ThemeEngine.register({
  ...
  activate(host) {
    ...
    frame.src = new URL('./coast-frame.html', import.meta.url).href;
    frame.title = 'Bờ Biển';
